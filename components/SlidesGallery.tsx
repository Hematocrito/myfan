  ...
  return (
    <div className="slider-container -top-10 sm:top-0">
      ...
      >
        ...
        <div
          className="absolute top-[50%] -translate-y-[50%] px-3 left-1 py-1 rounded-full bg-black bg-opacity-20 text-white text-opacity-30 text-lg"
          onClick={() =>
        ...
        <div
          className="absolute top-[50%] -translate-y-[50%] px-3 right-1 py-1 rounded-full bg-black bg-opacity-20 text-white text-opacity-30 text-lg"
          onClick={() =>
            setPage(
